 ...
 */
class Version20170104183615 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, child_id, user_id, course_id FROM participant');
        ...
        $this->addSql('INSERT INTO participant (id, child_id, user_id, course_id) SELECT id, child_id, user_id, course_id FROM __temp__participant');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_D79F6B11591CC992');
        $this->addSql('DROP INDEX IDX_D79F6B11A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, child_id, course_id, user_id FROM participant');
        $this->addSql('DROP TABLE participant');
        $this->addSql('CREATE TABLE participant (id INTEGER NOT NULL, child_id INTEGER DEFAULT NULL, course_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO participant (id, child_id, course_id, user_id) SELECT id, child_id, course_id, user_id FROM __temp__participant');
        $this->addSql('DROP TABLE __temp__participant');
        $this->addSql('CREATE INDEX IDX_D79F6B11DD62C21B ON participant (child_id)');
        $this->addSql('CREATE INDEX IDX_D79F6B11591CC992 ON participant (course_id)');
        $this->addSql('CREATE INDEX IDX_D79F6B11A76ED395 ON participant (user_id)');
