...
class User implements UserInterface, EquatableInterface
{
     ...
     * @var Child[]
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Child", mappedBy="parent", cascade={"remove"})
     */
    private $children;
     ...
     * @var Participant[]
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Participant", mappedBy="user", cascade={"remove"})
     */
     ...
     * @var Tutor[]
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Tutor", mappedBy="user", cascade={"remove"})
     */
    private $tutors;
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\CourseQueueEntity", mappedBy="user", cascade={"remove"})
     */
    private $queues;
