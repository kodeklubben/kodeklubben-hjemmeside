...
class Child
{
     ...
     * @var Participant[]
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Participant", mappedBy="child", cascade={"remove"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\CourseQueueEntity", mappedBy="child", cascade={"remove"})
     */
    private $queues;
