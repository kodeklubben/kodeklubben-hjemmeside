...
class UserController extends Controller
{
    ...
    private function removeCurrentTutors($user)
    {
        ...
        $manager = $this->getDoctrine()->getManager();
        $courses = $this->getDoctrine()->getRepository('AppBundle:Course')->findByTutorThisAndLaterSemesters($user);
    ...
    {
        $manager = $this->getDoctrine()->getManager();
        $courses = $this->getDoctrine()->getRepository('AppBundle:Course')->findByTutor($user);
        foreach ($courses as $course) {
            $course->removeTutor($user);
            $manager->persist($course);
        }
